    ...
    return(
        <div className="container-sobre">
            <div className="parte-one">
                <Image src="/img/barraDeitada.png" alt="" width={1500} height={2}/>
                <div className='conteudo'>
                    <h1>NOSSO PROPÓSITO É SER UM GUINCHO CONFIÁVEL PARA VOCÊ</h1>
                    <Image src="/img/imgSobre.png" alt="" width={400} height={600}/>
                </div>
                <Image src="/img/barraDeitada.png" alt="" width={1500} height={1000}/>    
            </div>
